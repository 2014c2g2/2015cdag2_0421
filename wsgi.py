...
class Hello(object):
    ...
    齒數3:<input type=text name=N2><br />
    齒數4:<input type=text name=N3><br />
    齒數5:<input type=text name=N4><br />
    齒數6:<input type=text name=N5><br />
    齒數7:<input type=text name=N6><br />
    模數  :<input type=text name=M><br />
    <input type=submit value=send>
    </form>
    <hr>

    <h1>輸入下列的表單，顯示出兩顆齒輪圖形</h1>
